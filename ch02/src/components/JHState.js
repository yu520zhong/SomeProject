...
export default class JHState extends Component {
    constructor(props) {
        super(props);
        this.state = {
            input: '',
    ...
    render() {
        return (
            <View style={{backgroundColor: '#f4f4f4', flex: 1}}>
                <TouchableOpacity style={{[marginTop:50,{styles.pwdInputStyle]}} onPress={()=>this.dealWithState(this.state.isGoodePerson)}>
